...
class SucursalesController{
    ...
    public function accion($data){        
        switch ($data['accion']) {   
            ...
            break;
            case "LIPF";//---[LISTAR PORA FORMULARIOS]
                return $this->ListarSucursalesParaFormularios($data);
            break;
    ...
    //---[ACTIVAS PROYECTO MENU ]---//---------------------------------------------------
        ...
        //---[FUNCIONAL MENU: AccionesAreas.js]
        private function ListarSucursalesParaFormularios($d){
            $this->objsucursales->setId_empresa($d['ID']);
            $Resptemp = $this->objsucursales->listarsucursalesparaformulario();
            return $Resptemp;
        }
